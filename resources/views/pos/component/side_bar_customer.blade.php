        ...
        <form class="search-form d-flex align-items-center" method="POST" action="#">
          <div class="col-md-11">
            <div class="form-floating">
              <input type="text" class="form-control" id="floatingName" placeholder="Search" title="Enter search keyword" name="search">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="btn-group" role="group" id="list_button_order_payment" aria-label="Basic mixed styles example">
          ...
          <a type="button" class="btn btn-outline-primary py-3" id="order_payment">Payment</a>
          <a type="button" class="btn btn-outline-primary py-3" id="order_delete">Delete</a>
        </div>
      </div>
      <div class="row" style="margin-top: 20px;" id="order_payment_method">
        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
          <a type="button" class="btn btn-outline-danger py-3" id="cash_payment">Cash</a>
          <a type="button" class="btn btn-outline-danger py-3">Vnpay</a>
        </div>
      </div>
