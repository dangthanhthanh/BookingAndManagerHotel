      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h2>{{$data->user_name??'User Name'}}</h2>
            <h3>Customer</h3>
          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade pt-3" id="profile-settings">
                ...
                <!-- Settings Form -->
                <form method="POST" action="{{route('customer.addToStaff',$data->slug)}}">
                  @csrf
                  <div class="row mb-3">
                    <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Add To Staff</label>
                    <div class="col-md-8 col-lg-9">
                      @foreach ($roles as $item)
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="role_{{$item->id}}" name="roles[]" value="{{$item->id}}">
