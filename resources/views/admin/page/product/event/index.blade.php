        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('event.add')}}">Add New</a>
                    </li>
                </ul>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        ...
                                                        data-url="{{ route('event.setstatus', ['slug'=>$item->slug])}}"
                                                        @checked($item->active)>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <form method="post" action="{{ route('event.delete', $item->slug) }}">
                                                        <a class="btn btn-primary" href="{{ route('event.description', $item->slug) }}"><i class="bi bi-file-play-fill"></i></a>
                                                        @csrf
