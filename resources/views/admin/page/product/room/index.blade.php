                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="min-width: 100px;">Capacity/Bed</th>
                                        ...
                                        @forelse ( $datas as $key => $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="post" action="{{ route('room.delete', $item->slug) }}">
                                                        <a class="btn btn-primary" href="{{ route('room.description', $item->slug) }}"><i class="bi bi-file-play-fill"></i></a>
                                                        @csrf
