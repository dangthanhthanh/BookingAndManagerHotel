                    ...
                    <div class="tab-pane fade show active profile-edit pt-3" >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-action" method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="fullName" class="col-md-2 col-lg-2 col-form-label"><strong>Title</strong></label>
                                        <div class="col-md-4">
                                            <label for="fullName" class="form-label"><strong></strong></label>
