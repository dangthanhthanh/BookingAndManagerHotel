                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col" style="min-width: 150px;">Title @include("admin.component.sort_by",['sortBy'=>'name'])</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        ...
                                                        data-url="{{ route('blog.setstatus', ['slug'=>$item->slug])}}"
                                                        @checked($item->active)>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <form method="post" action="{{ route('blog.delete', $item->slug) }}">
                                                        <a class="btn btn-primary" href="{{ route('blog.description', $item->slug) }}"><i class="bi bi-file-play-fill"></i></a>
                                                        @csrf
