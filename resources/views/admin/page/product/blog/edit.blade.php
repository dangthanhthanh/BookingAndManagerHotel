...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route("blog.index")}}">Room Category</a></li>
        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('blog.index') }}">Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('blog.add') }}">Add New</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('blog.description',$data->slug) }}">Description</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-action" method="POST" action="{{ route('blog.update',$data->slug) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="" class="col-md-2 col-lg-2 col-form-label"><strong>Title</strong></label>
                                        <div class="col-md-4">
