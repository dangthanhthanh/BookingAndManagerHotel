        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('food.description',$data->slug) }}">Description</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-action" method="POST" action="{{ route('food.update',$data->slug) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
