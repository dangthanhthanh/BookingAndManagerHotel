                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch">
                                                        ...
                                                        data-url="{{ route('service.setstatus', ['slug'=>$item->slug])}}"
                                                        @checked($item->active)>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <form method="post" action="{{ route('service.delete', $item->slug) }}">
                                                        <a class="btn btn-primary" href="{{ route('service.description', $item->slug) }}"><i class="bi bi-file-play-fill"></i></a>
                                                        @csrf
