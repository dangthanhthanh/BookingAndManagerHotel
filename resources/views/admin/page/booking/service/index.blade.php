...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{route('booking.service.index')}}">Service</a></li>
      </ol>
    </nav>
</div><!-- End Page Title -->
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Service @include("admin.component.sort_by",['sortBy'=>'service_id'])</th>
