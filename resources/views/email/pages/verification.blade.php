...
<p> Thanks</p>
@endsection<!-- Free to use, HTML email template designed & built by FullSphere. Learn more about us at www.fullsphere.co.uk -->
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
               <style>
                  p{
                     font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;
                  }
               </style>
              <p>Hello!</p><br>
               <p>You are receiving this email because we received a verify request for your account.</p><br>
              ...
              <a href="{{$url}}" target="_blank" style="background-color: #000000; font-size: 15px; line-height: 22px; font-family: 'Helvetica', Arial, sans-serif; font-weight: normal; text-decoration: none; padding: 12px 15px; color: #ffffff; border-radius: 5px; display: inline-block; mso-padding-alt: 0;">
                ...
                <![endif]-->
                  ...
                  <span style="mso-text-raise: 15pt; color: #ffffff;">Veryfication</span>
                  <!--[if mso]>
                  <i style="letter-spacing: 25px; mso-font-width: -100%;">&nbsp;</i>
                <![endif]-->
              </a>
              <!-- End button here -->
              <p>This verify link will expire in 60 minutes.</p><br>
              <p>If you did not request a verify, no further action is required.</p><br>
              <p>Regards,</p><br>
              <p> BookingAndManager</p><br>
            </td>
          </tr>
        </tbody>
      </table>
